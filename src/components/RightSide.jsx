...
const RightSide = () => {
  return (
    <div className='pr-17 py-35'>
        <div className='relative overflow-hidden card-shine w-110 h-110 bg-gradient-to-br from-[#1c2836] to-black ring-8 ring-[#101928] rounded-4xl shadow-[0px_10px_200px_150px_#f0b10015] flex flex-col items-center justify-center'>
            <div className=''>
